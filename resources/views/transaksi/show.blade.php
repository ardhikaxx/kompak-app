    ...
    <div class="col-md-8">
        ...
        <div class="glass-card p-5" id="printableArea">
            <div class="text-center mb-4 border-bottom border-secondary pb-4">
                ...
                <p class="text-white mb-0 small">Sistem Manajemen Bisnis & Kasir</p>
            </div>

            <div class="row mb-4">
                <div class="col-sm-6">
                    <p class="mb-1 text-white small">KODE TRANSAKSI</p>
                    <h6 class="text-white fw-bold font-mono">{{ $transaksi->kode_transaksi }}</h6>
                </div>
                <div class="col-sm-6 text-sm-end">
                    <p class="mb-1 text-white small">TANGGAL TRANSAKSI</p>
            ...
            <div class="row mb-4">
                <div class="col-sm-6">
                    <p class="mb-1 text-white small">PELANGGAN</p>
                    <h6 class="text-white">{{ $transaksi->pelanggan->nama_pelanggan ?? 'Pelanggan Umum' }}</h6>
                </div>
                <div class="col-sm-6 text-sm-end">
                    <p class="mb-1 text-white small">KASIR</p>
            ...
            <div class="table-responsive mb-4 border-bottom border-secondary pb-2">
                <table class="table table-borderless text-white">
                    <thead class="text-white small border-bottom border-secondary">
                        <tr>
                            <th>Item</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="small text-white">{{ $detail->produk->kode_produk ?? '-' }}</div>
                            </td>
            ...
            <div class="row justify-content-end">
                <div class="col-sm-6 col-md-5">
                    ...
                    <div class="d-flex justify-content-between mb-3 mt-3 pt-3 border-top border-secondary">
                        ...
                        <span class="text-white fw-bold fs-5">Rp {{ number_format($transaksi->total, 0, ',', '.') }}</span>
                    </div>
                    <div class="d-flex justify-content-between mb-2 small text-white">
                        <span>Bayar ({{ $transaksi->metode_bayar }})</span>
                        <span>Rp {{ number_format($transaksi->bayar, 0, ',', '.') }}</span>
                    </div>
                    <div class="d-flex justify-content-between mb-0 small text-white">
                        <span>Kembalian</span>
