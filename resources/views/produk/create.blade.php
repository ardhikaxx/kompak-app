...
<div class="page-header mb-4">
    <div>
        <h4 class="page-title mb-1">
            <i class="fas fa-plus-circle me-2 text-accent"></i> Tambah Produk
        </h4>
            ...
            <div class="col-md-8">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="kode_produk" class="form-glass @error('kode_produk') border-danger @enderror" value="{{ old('kode_produk') }}" required placeholder="Contoh: PRD-001">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama_produk" class="form-glass @error('nama_produk') border-danger @enderror" value="{{ old('nama_produk') }}" required placeholder="Masukkan nama produk">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="harga_beli" class="form-glass @error('harga_beli') border-danger @enderror" value="{{ old('harga_beli', 0) }}" required min="0">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="harga_jual" class="form-glass @error('harga_jual') border-danger @enderror" value="{{ old('harga_jual', 0) }}" required min="0">
                        @error('harga_jual') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-glass-label">Stok Awal <span class="text-danger">*</span></label>
                        <input type="number" name="stok" class="form-glass @error('stok') border-danger @enderror" value="{{ old('stok', 0) }}" required min="0">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="stok_minimum" class="form-glass @error('stok_minimum') border-danger @enderror" value="{{ old('stok_minimum', 5) }}" required min="1">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="satuan" class="form-glass @error('satuan') border-danger @enderror" value="{{ old('satuan', 'Pcs') }}" required placeholder="Pcs, Kg, dll">
                        @error('satuan') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
                    <div class="col-md-12">
                        <label class="form-glass-label">Deskripsi Produk</label>
                        <textarea name="deskripsi" class="form-glass @error('deskripsi') border-danger @enderror" rows="3" placeholder="Opsional">{{ old('deskripsi') }}</textarea>
